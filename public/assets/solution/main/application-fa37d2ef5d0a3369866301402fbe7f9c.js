...
var App = function () {
    ...
    function handleIEFixes() {
        ...
        if (false && jQuery.browser.msie && jQuery.browser.version.substr(0, 1) < 9) { // ie7&ie8
...
var scrolltotop={
	...
	controlHTML: '<span style="font-size:20px">▲</span>', //<img src="assets/img/up.png" style="width:51px; height:42px" />', //HTML for control, which is auto wrapped in DIV w/ ID="topcontrol"
        ...
        methods = {
            init: function(options) {
                ...
                return this.each(function() {
                    ...
                    if(stickyWrapper.css('height') == '50px')
                        stickyWrapper.css('height', '70px');
                    sticked.push({
...
(function() {
  $(function() {
    ...
    return $('.production a').click(function() {
      $('.production a').each(function() {

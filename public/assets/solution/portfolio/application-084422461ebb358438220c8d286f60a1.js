...
(function (window, $, undefined) {
    ...
    $.infinitescroll.defaults = {
        loading: {
            finished: undefined,
            finishedMsg: "<em>Фотографий в данном альбоме больше нет..</em>",
            ...
            msg: null,
            msgText: "<em>Загрузка фотографий..</em>",
            selector: null,
            speed: 'fast',
            start: undefined
        },
...
(function() {
  jQuery(function() {
    ...
    return $('#portfolios').infinitescroll({
      navSelector: 'nav.pagination',
      nextSelector: 'nav.pagination a[rel=next]',
      itemSelector: '#portfolios .portfolio',
